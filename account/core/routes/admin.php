...
use App\Http\Controllers\Admin\DspManagementController;
use App\Http\Controllers\Admin\VoucherController;
use App\Http\Controllers\Admin\DspFormulasController;
use App\Http\Controllers\Admin\ShareUserController;
use App\Http\Controllers\Admin\UsersSummeryController;
...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('RoyaltyBonusController')->group(function () {
    Route::get('schedule', 'setDateForm')->name('bonus.schedule');
	Route::get('eligible-users', 'listEligibleUsers')->name('bonus.eligible_users'); 
    Route::post('set-date/save', 'saveDate')->name('bonus.set_date.save');
    Route::post('transaction-detail/save', 'saveTransactionDetail')->name('bonus.transaction_detail.save');
    Route::post('distribute', 'distributeBonus')->name('bonus.distribute');
		
    });
		
	Route::controller(ShareUserController::class)->group(function () {
    Route::get('share-users', 'index')->name('share.users');
    Route::get('share-user/search', 'searchUser')->name('share.user.search');
    Route::post('share-user/update', 'updateShareStatus')->name('share.user.update');
});
		...
		Route::prefix('dsp-formulas')->group(function () {
    Route::get('/', [DspFormulasController::class, 'index'])->name('dsp.formulas');
    Route::post('/save', [DspFormulasController::class, 'save'])->name('dsp.formulas.save');
});
		
		// Bonus Management Routes
    Route::controller(BonusManagementController::class)->prefix('bonus-management')->name('bonus.management.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/update', 'update')->name('update');
    });
		
    Route::middleware(['auth:admin'])->group(function () {
    Route::get('dsp-management', [DspManagementController::class, 'index'])->name('dsp.management');
		Route::get('dsp-bonuses', [DspManagementController::class, 'dspBonuses'])->name('dsp.bonuses.index');
        Route::post('dsp-bonuses/update', [DspManagementController::class, 'updateDspBonuses'])->name('dsp.bonuses.update');
});
	...
	Route::get('users-summary', [UsersSummeryController::class, 'summary'])->name('users.summary');
    ...
    Route::controller(BrightFutureController::class)->prefix('bright-future')->name('bright.future.')->group(function () {
        ...
        Route::get('manual-profit', 'manualProfit')->name('manual.profit');
        Route::post('manual-profit', 'manualProfitSubmit')->name('manual.profit.submit');
    });
	
	Route::controller(PairsManagementController::class)->prefix('pairs-management')->name('pairs.management.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/downline-summary', 'getDownlinePairs')->name('downline.summary');
		
		// New Log Route
        Route::get('/bonus-log', 'getPairBonusLog')->name('bonus.log');
        Route::get('mismatches', 'findPairMismatches')->name('mismatches');
        // New Settings Routes
        ...
        Route::post('/status/update', 'updateLimitStatus')->name('status.update');
    });
