    ...
    <div class="wallet-overview">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                ...
                <div class="wallet-balance-amount">{{ getAmount(auth()->user()->balance) }} <span style="font-size: 1.5rem">{{ gs()->cur_text }}</span></div>
    ...
    <div class="stats-grid">
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->epin_credit) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->dsp_ref_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->royalty_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->pair_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->shop_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->franchise_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->dds_ref_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->shop_reference) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->franchise_ref_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->city_ref_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
            <div class="icon-box variant-pink mb-0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg></div>
        </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->weekly_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->product_partner_bonus) }} {{ gs()->cur_text }}</h3>
            </div>
            <div class="icon-box variant-blue mb-0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg></div>
        </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->promo) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount(auth()->user()->total_invest) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount($totalDeposit) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount($totalWithdraw) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount($completeWithdraw) }} {{ gs()->cur_text }}</h3>
            </div>
        ...
        <div class="premium-card stat-item">
            <div class="stat-info">
                ...
                <h3>{{ getAmount($pendingWithdraw) }} {{ gs()->cur_text }}</h3>
            </div>
