                ...
                <div class="premium-sidebar dashboard-sidebar">
                    ...
                    <div class="sidebar-scroll-wrapper">
                        ...
                        <ul class="user-dashboard-tab">
                            ...
                            <li>
                                <a class="{{menuActive('user.bright.future.plan')}}" href="{{ route('user.bright.future.plan') }}">
                                    <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                                    @lang('Bright Future Plan')
                                </a>
                            </li>
                            <li>
