...
class POSOrderController extends BaseController
{
    ...
    public function placeOrder(Request $request): JsonResponse
    {
		...
		$order->username = $customerUsername;
        $order->save();
		
		$seller = auth('seller')->user(); 
        $sellerType = $seller->vendor_type;
        ...
        $seller = auth('seller')->user();
        $sellerType = $seller->vendor_type;
        $customerUsername = $order->customer?->username ?? $user->username;
        ...
        $this->userService->updateSecondaryUserBonuses(
            ...
            $bonuses['bv'],
            $bonuses['pv'],
            $bonuses['dds_ref_bonus'],
            $bonuses['shop_bonus'],
            $bonuses['shop_reference'],
            $bonuses['franchise_bonus'],
            $bonuses['franchise_ref_bonus'],
			$bonuses['company_partner_bonus'],
			$bonuses['product_partner_bonus'],
			$bonuses['royalty_bonus'],
			$bonuses['city_ref_bonus'],
			$cart,
			$bonuses
        );
