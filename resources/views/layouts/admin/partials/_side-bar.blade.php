...
<aside class="js-aside aside d-none d-lg-block">
    ...
    <div class="aside-body search-aside-attribute-container py-4 pt-0">
        ...
        <ul class="aside-nav navbar-nav gap-2">
            ...
            @endif
			<!-- Bonus Management -->
@if (Helpers::module_permission_check('bonus_management'))
    <li class="{{ Request::is('admin/bonus-management*') || Request::is('admin/bonus-wallets*') || Request::is('admin/wallets-history*') ? 'sub-menu-opened' : '' }}">
        <a class="nav-link nav-link-toggle" href="javascript:void(0);" title="{{ translate('Bonus Management') }}">
            ...
            <span class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                {{ translate('Bonus Management') }}
                <i class="fi fi-sr-angle-down"></i>
            </span>
        </a>
        <ul class="aside-submenu navbar-nav" style="display: {{ Request::is('admin/bonus-management*') || Request::is('admin/bonus-wallets*') || Request::is('admin/wallets-history*') ? 'block' : 'none' }}">
            <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">{{ translate('Bonus Management') }}</li>
            <li class="nav-item {{ Request::is('admin/bonus-wallets*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.bonus-wallets.index') }}" title="{{ translate('Bonus Wallets') }}">
                    <span class="text-truncate">{{ translate('Bonus Wallets') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('admin/bonus-management') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.bonus-management.index') }}" title="{{ translate('View Bonuses') }}">
                    <span class="text-truncate">{{ translate('View Bonuses') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('admin/wallets-history*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.bonus-management.wallets-history') }}" title="{{ translate('Wallets History') }}">
                    <span class="text-truncate">{{ translate('Wallets History') }}</span>
                </a>
            </li>
        </ul>
    </li>
...
@if (Helpers::module_permission_check('order_management'))
    <li class="{{ Request::is('admin/formulas*') ? 'sub-menu-opened' : '' }}">
        <a class="nav-link nav-link-toggle" href="javascript:void(0);" title="{{ translate('Formula Management') }}">
            <i class="fi fi-sr-calculator"></i>
            <span class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                {{ translate('Formula Management') }}
                <i class="fi fi-sr-angle-down"></i>
            </span>
        </a>
        <ul class="aside-submenu navbar-nav" style="display: {{ Request::is('admin/formulas*') ? 'block' : 'none' }}">
            <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">{{ translate('Formula Management') }}</li>
            <li class="nav-item {{ Request::is('admin/formulas') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.formulas.index') }}" title="{{ translate('View Formulas') }}">
                    <span class="text-truncate">{{ translate('View Formulas') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('admin/formulas/create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.formulas.create') }}" title="{{ translate('Create Formula') }}">
                    <span class="text-truncate">{{ translate('Create Formula') }}</span>
                </a>
            </li>
        </ul>
    </li>

    <!-- Pro Manual Order Rules -->
    <li class="{{ Request::is('admin/pro-manual-order-rules*') ? 'sub-menu-opened' : '' }}">
        <a class="nav-link nav-link-toggle" href="javascript:" title="{{ translate('Pro Manual Order Rules') }}">
            <i class="fi fi-sr-shield-check"></i>
            <span class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                {{ translate('Pro Manual Order Rules') }}
                <i class="fi fi-sr-angle-down"></i>
            </span>
        </a>
        <ul class="aside-submenu navbar-nav" style="display: {{ Request::is('admin/pro-manual-order-rules*') ? 'block' : 'none' }}">
            <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">{{ translate('Pro Manual Order Rules') }}</li>
            <li class="nav-item {{ Request::is('admin/pro-manual-order-rules') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.pro-manual-order.index') }}" title="{{ translate('Manage Rules') }}">
                    <span class="text-truncate">{{ translate('Manage Rules') }}</span>
                </a>
            </li>
        </ul>
    </li>
@endif
 ...
 <!-- Start Order Management -->
                @if(Helpers::module_permission_check('order_management'))
                    <li class="{{ Request::is('admin/shop-orders*') || Request::is('admin/franchise-orders*') ? 'sub-menu-opened' : '' }}">
                        <a class="nav-link nav-link-toggle {{ Request::is('admin/shop-orders*') || Request::is('admin/franchise-orders*') ? 'active' : '' }}"
                           href="javascript:void(0);" title="{{ translate('Order Management') }}">
                            <i class="fi fi-sr-shopping-cart"></i>
                            <span class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                                {{ translate('Shop & Franchise Orders') }}
                                <i class="fi fi-sr-angle-down"></i>
                            </span>
                        </a>
                        <ul class="aside-submenu navbar-nav" style="display: {{ Request::is('admin/shop-orders*') || Request::is('admin/franchise-orders*') ? 'block' : 'none' }};">
                            <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">
                                {{ translate('Shop & Franchise Orders') }}
                            </li>

                            <!-- Shop Orders -->
                            <li class="nav-item {{ Request::is('admin/shop-orders') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.shop.orders') }}"
                                   title="{{ translate('Shop Orders') }}">
                                    <span class="text-truncate">{{ translate('Shop Orders') }}</span>
                                </a>
                            </li>

                            <!-- Franchise Orders -->
                            <li class="nav-item {{ Request::is('admin/franchise-orders') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.franchise.orders') }}"
                                   title="{{ translate('Franchise Orders') }}">
                                    <span class="text-truncate">{{ translate('Franchise Orders') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            @if(Helpers::module_permission_check('business_settings'))
                ...
                <li>
                    <a class="nav-link {{
                                ...
                                Request::is('admin/business-settings/referral-setting') ||
            ...
            @if(Helpers::module_permission_check('system_settings'))
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/ai-settings') ? 'active' : '' }}"
                       href="{{ route('admin.ai-settings.index') }}"
                       title="{{ translate('AI_Settings') }}">
            ...
            @if(Helpers::module_permission_check('3rd_party_setup'))
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/shipping-setup*') ? 'active' : '' }}"
                       href="{{ route('admin.shipping-setup.index') }}"
                       title="{{ translate('Shipping Setup') }}">
