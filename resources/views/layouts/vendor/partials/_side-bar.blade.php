...
<div id="sidebarMain" class="d-none">
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between side-logo dashboard-navbar-side-logo-wrapper">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close me-3">
                    <i class="fi fi-rr-menu-burger navbar-vertical-aside-toggle-short-align"></i>
    ...
    <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/buy-products*') || Request::is('vendor/order-history*') ? 'active' : '' }}">
        ...
        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
            style="display: {{ Request::is('vendor/buy-products*') || Request::is('vendor/order-history*') ? 'block' : 'none' }};">
              <!-- New Products List -->
            <li class="nav-item {{ Request::is('vendor/order-history/products') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('vendor.order.history.products.list') }}">
                    <span class="tio-circle nav-indicator-icon"></span>
                    <span class="text-truncate">{{ translate('products_list') }}</span>
                </a>
            </li>
            <!-- Buy Products -->
            <li class="nav-item {{ Request::is('vendor/buy-products') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('vendor.buy.products') }}">
                    <span class="tio-circle nav-indicator-icon"></span>
                    <span class="text-truncate">{{ translate('Buy Products') }}</span>
                </a>
            </li>

            <!-- Order History -->
            <li class="nav-item {{ Request::is('vendor/order-history') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('vendor.order.history') }}">
                    <span class="tio-circle nav-indicator-icon"></span>
                    <span class="text-truncate">{{ translate('Order History') }}</span>
                </a>
            </li>
...
@endif
						...
						<li class="navbar-vertical-aside-has-menu {{Request::is('vendor/request-brand*')?'active':''}}">
    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
    ...
    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
        style="display: {{Request::is('vendor/request-brand*')?'block':'none'}}">
        <li class="nav-item {{Request::is('vendor/request-brand')?'active':''}}"
            title="{{translate('request_brand')}}">
            <a class="nav-link " href="{{route('vendor.request.brand')}}">
                <span class="tio-circle nav-indicator-icon"></span>
                <span class="text-truncate">{{translate('request_brand')}}</span>
            </a>
        </li>
    </ul>
</li>
