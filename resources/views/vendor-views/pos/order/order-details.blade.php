                                ...
                                @foreach($order->details as $key=>$detail)
                                    ...
                                    @if($productDetails)
                                        <tr>
                                            ...
                                            <td>{{($productDetails['pv'] ?? 0) * $detail['qty']}}</td>
                                            <td>{{($productDetails['bv'] ?? 0) * $detail['qty']}}</td>
                                        ...
                                        @php($total += $subtotal)
                                        @php($totalPv += ($productDetails['pv'] ?? 0) * $detail['qty'])
                                        @php($totalBv += ($productDetails['bv'] ?? 0) * $detail['qty'])
                                    @endif
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-6 title-color">
                                        <strong>{{setCurrencySymbol(amount: usdToDefaultCurrency(amount:  $total), currencyCode: getCurrencyCode()) }}</strong>
                                    </dd>
                                    <dt class="col-5 text-capitalize">{{ translate('total_PV') }}</dt>
                                    <dd class="col-6 title-color">
                                        <strong>{{$totalPv}}</strong>
                                    </dd>
                                    <dt class="col-5 text-capitalize">{{ translate('total_BV') }}</dt>
                                    <dd class="col-6 title-color">
                                        <strong>{{$totalBv}}</strong>
                                    </dd>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media flex-wrap gap-3 align-items-center">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
									...
									<span class="title-color break-all"><strong>{{strtoupper($order->customer['username'])}}</strong></span>
                                        <span
