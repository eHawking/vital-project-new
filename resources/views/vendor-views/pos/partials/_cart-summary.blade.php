...
@if ($summaryData['currentCustomer'] !== null && $currentCustomerData !== null)
    ...
    <div>
        ...
        <span class="value">{{ $currentCustomerData?->f_name.' '.$currentCustomerData?->l_name }}</span>
			    ...
			    <div>
        <span class="key custom-flex-basis">{{ translate('username') }}</span>
        <span>:</span>
        <span class="value">{{ $currentCustomerData?->username }}</span>
    </div>
    <div>
        <span class="key custom-flex-basis">{{ translate('contact') }}</span>
        <span>:</span>
        <a href="tel:{{ $currentCustomerData?->phone }}" class="value text-dark">
