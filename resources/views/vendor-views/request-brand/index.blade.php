...
@section('title', translate('request_new_brand'))
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('vendor.request.brand.submit') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="brand_name" class="form-control" id="name" value=""
                                               placeholder="{{ translate('ex') }} : {{translate('LUX') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
