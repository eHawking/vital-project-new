    ...
    <div class="content container-fluid">
        ...
        <div class="row mt-20">
            <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center text-capitalize">{{ translate('retail_price') }}</th>
								<th class="text-center text-capitalize">{{ translate('selling_price') }}</th>
                                <th class="text-center text-capitalize">{{ translate('margin') }}</th>
                ...
                <td class="text-center">
                    {{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $product['vendor_margin']), currencyCode: getCurrencyCode()) }}
                </td>
                                    <td class="text-center">
