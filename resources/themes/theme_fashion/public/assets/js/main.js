(function ($) {
    ...
    $(document).ready(function () {
        ...
        const clearanceSell = $(".clearance-sell-slider").owlCarousel({
            margin: 16,
            items: 2,
            responsiveClass: true,
            nav: false,
        ...
        $(".recommended-next").on("click", function () {
            $(this)
                .closest("section")
                .find(".recommended-slider")
                .trigger("next.owl.carousel", [600]);
        });
        $(".recommended-prev").on("click", function () {
            $(this)
                .closest("section")
                .find(".recommended-slider")
                .trigger("prev.owl.carousel", [600]);
        });
        $(window).on("load", function () {
        ...
        if ($("#input-slider").length) {
            ...
            // Values are parsed as numbers using the "from" function in "format"
            formatSlider.noUiSlider.set(["0", "100000000000"]);
        ...
        $(".qtyBtn").on("click", function () {
            ...
            var outofstock = $(".addToCartDynamicForm").data("outofstock");
            var newVal = oldValue;
            ...
            try {
                let addToCartDynamicForm = $(this).closest(
                    ".addToCartDynamicForm"
                );
                if (addToCartDynamicForm.hasClass("add-to-cart-details-form")) {
                    getVariantPrice(".add-to-cart-details-form");
                }
                if (addToCartDynamicForm.hasClass("add-to-cart-sticky-form")) {
