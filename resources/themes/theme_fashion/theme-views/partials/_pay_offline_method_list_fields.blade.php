@if ($method)
    ...
    <div class="payment-list-area">
            ...
            $get_shipping_cost_saved_for_free_delivery = \App\Utils\CartManager::getShippingCostSavedForFreeDelivery(type: 'checked');
    ...
    <div class="d-flex gap-10 justify-content-end pt-4">
        <button type="button" class="btn rounded btn-danger form-cancel-button" data-bs-dismiss="modal">{{translate('close')}}</button>

        <button type="submit" class="btn rounded btn-base px-4 form-loading-button">
