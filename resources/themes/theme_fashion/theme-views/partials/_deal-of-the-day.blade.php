                            ...
                            <div class="deal-content">
                                <div class="product-single-content">
                                    ...
                                    <div class="price">
                                        ...
                                        <h4>
                                            @if(!auth('customer')->check() && isset($dealOfTheDay->product->guest_price))
                                                <span>{{ webCurrencyConverter($dealOfTheDay->product->guest_price) }}</span>
                                                @if($dealOfTheDay->product->guest_price < $dealOfTheDay->product->unit_price)
                            ...
                            <div class="deal-content">
                                <div class="product-single-content">
                                    ...
                                    <div class="price">
                                        {{-- GUEST PRICE LOGIC START --}}
                                        <h4>
                                            @if(!auth('customer')->check() && isset($recommendedProduct->guest_price))
                                                <span>{{ webCurrencyConverter($recommendedProduct->guest_price) }}</span>
                                                @if($recommendedProduct->guest_price < $recommendedProduct->unit_price)
