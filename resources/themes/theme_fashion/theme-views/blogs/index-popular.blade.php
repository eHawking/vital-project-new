    ...
    <div class="blog-root-container" data-platform="{{ isset($blogPlatform) && $blogPlatform == 'app' ? 'app' : 'web' }}" data-theme="{{ request('theme', 'light') }}">
        <div class="container">
                    ...
                    <form action="{{ isset($blogPlatform) && $blogPlatform == 'app' ? route('app.blog.popular-blog', ['locale' => request('locale'), 'theme' => request('theme')]) : route('frontend.blog.popular-blog') }}" id="popular-search-form" method="get">
                        ...
                        <div class="input-group-overlay input-group-sm position-relative">
                            ...
                            <input placeholder="{{ translate('Search_Blog') }}"
                                   class="__inline-38 cz-filter-search form-control form-control-sm appended-form-control h-45px bg-absolute-white form-control-dark-mode" id="popular-search"
                                   type="text" name="search" value="{{ request('search') }}" required>
            ...
            <div class="row g-4 sticky-top-nav-search">
                <div class="col-lg-12 order-1 order-lg-0 mb-3">
            ...
            <div class="row g-4">
                ...
                @if($popularBlogList->total() <= 0 && (request()->has('search') || request()->has('category') || request()->has('write')))
