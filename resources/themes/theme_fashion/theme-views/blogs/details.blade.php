            ...
            <div class="row g-4 justify-content-center mt-3">
                @if(count($articleLinks) > 0)
                    <div class="col-lg-3">
                        ...
                        <div class="article-nav-wrapper sticky-top-wrapper sticky-top-blog-details card shadow-lg border-0 p-3 pt-4 pt-lg-3 d-none d-lg-block">
                ...
                <div class="{{ count($articleLinks) > 0 ? 'col-lg-6 pt-0 pt-sm-2 mt-3' : 'col-lg-9' }}">

                    <div class="mt-4 mb-3">
                        @if(request('source') == 'draft')
                            <div class="text-center">
                                <span class="btn btn-outline-danger border border-danger fs-13 mb-3 px-3 py-2 rounded text-center">
                            ...
                            @if(isset($blogPlatform) && $blogPlatform == 'app')
                                @if($blogData->writer)
                                    <span class="border-inline-end pe-3">
                                        {{ translate('By') }}
                                       <a href="{{ route('app.blog.index', ['writer' => $blogData?->writer, 'locale' => request('locale'), 'theme' => request('theme')]) }}" class="opacity-1 fw-semibold title-color"
                                          title="{{ $blogData?->writer ?? '' }}">
                                            {{ Str::limit($blogData?->writer ?? '', 50, '...') }}
                                        </a>
                                    </span>
                                @endif
                            @else
                                @if($blogData->writer)
                                    <span class="border-inline-end pe-3">
                                        {{ translate('By') }}
                                       <a href="{{ route('frontend.blog.index', ['writer' => $blogData?->writer]) }}" class="opacity-1 fw-semibold title-color"
                                          title="{{ $blogData?->writer ?? '' }}">
                                            {{ Str::limit($blogData?->writer ?? '', 50, '...') }}
                                        </a>
                                    </span>
                    ...
                    <div data-bs-spy="scroll" data-bs-target="#simple-list-example" data-bs-offset="0" data-bs-smooth-scroll="true" class="scrollspy-blog-details" tabindex="0">
                        <img class="max-height-420px w-100 aspect-2 rounded-10 mb-4 mb-sm-5"
                             src="{{ getStorageImages(path: $blogData?->thumbnail_full_url, type:'wide-banner') }}"
                             alt="{{ $blogData?->title }}">
                        ...
                        <div class="sticky-top-wrapper sticky-top-blog-details text-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-3 mt-2">
                                ...
                                <a href="javascript:" class="social_share_function"
                                   data-url="{{ route('frontend.blog.details', ['slug' => $blogData?->slug]) }}"
                                   data-social="facebook.com/sharer/sharer.php?u=">
                                    <img width="30" src="{{theme_asset(path: 'assets/img/blogs/facebook.svg')}}" alt="">
                                </a>

                                <a href="javascript:"
                                   class="social_share_function"
                                   data-url="{{ route('frontend.blog.details', ['slug' => $blogData?->slug]) }}"
                                   data-social="twitter.com/intent/tweet?text=">
                                    <img width="30" src="{{theme_asset(path: 'assets/img/blogs/twitter.svg')}}" alt="">
                                </a>
                                ...
                                <a href="javascript:"
                                   ...
                                   data-social="linkedin.com/shareArticle?mini=true&url=">
                                    <img width="30" src="{{theme_asset(path: 'assets/img/blogs/linkedin.svg')}}" alt="">
                                </a>
                                ...
                                <a href="javascript:"
                                   ...
                                   data-social="api.whatsapp.com/send?text=">
                                    <img width="30" src="{{theme_asset(path: 'assets/img/blogs/whatsapp.svg')}}" alt="">
                                </a>
                ...
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        <h2 class="fs-18 fs-16-mobile fw-medium mb-3">{{ translate('Share_this_article') }}</h2>
                        ...
                        <div class="">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
                                <h2 class="fw-bold mb-0 fs-20">{{ translate('Popular_blogs') }}</h2>
