...
{{-- Consolidate Firebase SDK loads - load each script only once --}}
<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-app.js"></script>
<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-auth.js"></script>
<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-messaging.js"></script>
<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-auth-recaptcha.js"></script>
...
<script>
    ...
    function initializeFirebaseGoogleRecaptcha(containerId, action) {
        try {
            ...
            console.error("Error in initializeFirebaseGoogleRecaptcha:", e);
        }
    }
    ...
    try {
        ...
        // --- MODIFICATION START ---
        let messaging;
        if (firebase.messaging.isSupported()) { // Check if messaging is supported
        ...
        try {
            // --- MODIFICATION START ---
            if (messaging) { // Only attempt FCM operations if messaging is supported
            // --- MODIFICATION END ---
            ...
            // --- MODIFICATION START ---
            } // End of if (messaging) block
            // --- MODIFICATION END ---
        } catch (e) {
            console.error("Error in FCM related code:", e);
        }
    } catch (e) {
    ...
    try {
        ...
        console.error("Error in displayNotification:", e);
    }
</script>