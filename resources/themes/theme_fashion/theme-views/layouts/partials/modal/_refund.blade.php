                ...
                <div class="d-flex flex-column flex-sm-row flex-wrap gap-4 justify-content-between mb-4">
                    <div class="cart-product">
                        ...
                        <div class="cont">
                            ...
                            <div class="d-flex column-gap-1">
                                ...
                                <strong>{{webCurrencyConverter($order_details->price)}}</strong>
                            </div>
                    ...
                    <div class="d-flex flex-column gap-1 fs-12">
                        ...
                        <span>
                            ...
                            <span>:</span>
                            <span>{{webCurrencyConverter($order_details->price)}}</span>
                        </span>
                        <span>
                            <span>{{ translate('Discount')}}</span>
                            <span>:</span>
                            <span>{{webCurrencyConverter($order_details->discount)}}</span>
                        </span>
                        <span>
                            <span>{{ translate('Tax')}}</span>
                            <span>:</span>
                            <span>{{webCurrencyConverter($order_details->tax)}}</span>
                        </span>
                    </div>
                    <?php
                    ...
                    <div class="d-flex flex-column gap-1 fs-12">
                        <span>
                            ...
                            <span>:</span>
                            <span>{{webCurrencyConverter($subtotal)}}</span>
                        </span>
                        <span>
                            <span>{{translate('coupon_discount')}}</span>
                            <span>:</span>
                            <span>{{webCurrencyConverter($coupon_discount)}}</span>
                        </span>
                        <span>
                            <span>{{translate('total_refundable_amount')}}</span>
                            <span>:</span>
                            <span> {{webCurrencyConverter($refund_amount)}}</span>
                        </span>
                    </div>
                </div>
