<div class="container rtl">
    ...
    @else
        <span class="text-accent fs-18 font-bold text-dark">
            {{ webCurrencyConverter(amount: $dealOfTheDay?->product?->guest_price ?? $dealOfTheDay?->product?->unit_price) }}
        </span>
    @endif
</h4>
                                    <button
    ...
    @else
        <span class="text-accent __text-22px text-dark">
            {{ webCurrencyConverter(amount: $recommendedProduct->guest_price ?? $recommendedProduct->unit_price) }}
        </span>
    @endif
</h4>
                                    <button
