...
use App\Http\Controllers\Vendor\BuyProductsController;
use App\Http\Controllers\Vendor\OrderHistoryController;
use App\Http\Controllers\Vendor\VendorProductController;
use App\Http\Controllers\Vendor\VendorBrandRequestController;

Route::group(['middleware' => ['seller'], 'prefix' => 'vendor', 'as' => 'vendor.'], function () {
    Route::get('request-brand', [VendorBrandRequestController::class, 'index'])->name('request.brand');
    Route::post('request-brand', [VendorBrandRequestController::class, 'submit'])->name('request.brand.submit');
});
...
Route::group(['middleware' => ['seller'], 'prefix' => 'vendor', 'as' => 'vendor.'], function () {
    // Buy Products Routes
    Route::get('buy-products', [BuyProductsController::class, 'index'])->name('buy.products');
    Route::post('buy-products/create-order', [BuyProductsController::class, 'createOrder'])->name('buy.products.create-order');

    // Order History Routes
    Route::get('order-history', [OrderHistoryController::class, 'index'])->name('order.history');
	
	 Route::get('order-history/products', [VendorProductController::class, 'index'])
        ->name('order.history.products.list')
        ->defaults('type', 'all');  
});
