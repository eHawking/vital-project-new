...
use App\Http\Controllers\Admin\ProManualOrderController;
use App\Http\Controllers\Admin\FormulaController;
use App\Http\Controllers\Admin\ShopAndFranchiseOrdersController;
use App\Http\Controllers\Admin\Product\ProductAIController;
use App\Http\Controllers\Admin\Settings\AISettingsController;
use App\Http\Controllers\Admin\AI\AIImagesController;
use App\Http\Controllers\Admin\BonusManagementController;
use App\Http\Controllers\Admin\BonusWalletController;
...
Route::prefix('admin')->name('admin.')->middleware('auth:admin')->group(function () {
    Route::get('bonus-management', [BonusManagementController::class, 'index'])->name('bonus-management.index');
    Route::get('bonus-management/create', [BonusManagementController::class, 'create'])->name('bonus-management.create');
    Route::post('bonus-management', [BonusManagementController::class, 'store'])->name('bonus-management.store');
    Route::get('bonus-management/{bonusManagement}/edit', [BonusManagementController::class, 'edit'])->name('bonus-management.edit');
    Route::put('bonus-management/{bonusManagement}', [BonusManagementController::class, 'update'])->name('bonus-management.update');
    Route::delete('bonus-management/{bonusManagement}', [BonusManagementController::class, 'destroy'])->name('bonus-management.destroy');
	Route::get('bonus-wallets', [BonusWalletController::class, 'index'])->name('bonus-wallets.index');
	Route::get('wallets-history', [BonusManagementController::class, 'walletsHistory'])
         ->name('bonus-management.wallets-history');
});
...
Route::prefix('admin')->name('admin.')->middleware('auth:admin')->group(function () {
    // Shop Orders
    Route::get('shop-orders', [ShopAndFranchiseOrdersController::class, 'shopOrders'])->name('shop.orders');
    Route::get('shop-orders/{id}', [ShopAndFranchiseOrdersController::class, 'shopOrderDetails'])->name('shop.order.details');
    Route::get('shop-orders/approve/{id}', [ShopAndFranchiseOrdersController::class, 'approveShopOrder'])->name('shop.order.approve');
    Route::get('shop-orders/cancel/{id}', [ShopAndFranchiseOrdersController::class, 'cancelShopOrder'])->name('shop.order.cancel');

    // Franchise Orders
    Route::get('franchise-orders', [ShopAndFranchiseOrdersController::class, 'franchiseOrders'])->name('franchise.orders');
    Route::get('franchise-orders/approve/{id}', [ShopAndFranchiseOrdersController::class, 'approveFranchiseOrder'])->name('franchise.order.approve');
	Route::get('franchise-orders/cancel/{id}', [ShopAndFranchiseOrdersController::class, 'cancelFranchiseOrder'])->name('franchise.order.cancel');
});

Route::prefix('admin')->middleware('auth:admin')->group(function () {
    Route::get('pro-manual-order-rules', [ProManualOrderController::class, 'index'])->name('admin.pro-manual-order.index');
    Route::get('pro-manual-order-rules/create', [ProManualOrderController::class, 'create'])->name('admin.pro-manual-order.create');
    Route::post('pro-manual-order-rules', [ProManualOrderController::class, 'store'])->name('admin.pro-manual-order.store');
    Route::get('pro-manual-order-rules/{id}/edit', [ProManualOrderController::class, 'edit'])->name('admin.pro-manual-order.edit');
    Route::put('pro-manual-order-rules/{id}', [ProManualOrderController::class, 'update'])->name('admin.pro-manual-order.update');
    Route::delete('pro-manual-order-rules/{id}', [ProManualOrderController::class, 'destroy'])->name('admin.pro-manual-order.delete');
});
...
// Group routes for product status updates
Route::prefix('admin/products')->group(function() {
    Route::post('/verified-status-update', [ProductController::class, 'updateVerifiedStatus'])->name('admin.products.verified-status-update');
    Route::post('/choice-status-update', [ProductController::class, 'updateChoiceStatus'])->name('admin.products.choice-status-update');
    Route::post('/pro-status-update', [ProductController::class, 'updateProStatus'])->name('admin.products.pro-status-update');
    Route::post('/vip-status-update', [ProductController::class, 'updateVipStatus'])->name('admin.products.vip-status-update');
    Route::post('/adult-status-update', [ProductController::class, 'updateAdultStatus'])->name('admin.products.adult-status-update');
	Route::post('/manual-status-update', [ProductController::class, 'manualStatusUpdate'])->name('admin.products.manual-status-update');
	
    Route::get('/review-products-status', [ProductController::class, 'reviewProductsStatus'])->name('admin.products.review-products-status');
    Route::post('/deactivate-incomplete-products', [ProductController::class, 'deactivateIncompleteProducts'])->name('admin.products.deactivate-incomplete-products');
   
});

Route::post('/products/bulk-formula', [ProductController::class, 'applyBulkFormula'])->name('admin.products.bulk-formula');

Route::post('/admin/products/bulk-update', [ProductController::class, 'bulkUpdate'])->name('admin.products.bulk-update');

// Route for applying rules dynamically (for pro customers) via AJAX
Route::post('apply-manual-order-rules', [ProManualOrderController::class, 'applyRulesToManualOrder'])->name('apply.manual.order.rules');

Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {

    Route::post('customer/update-pro-status', [CustomerController::class, 'updateProStatus'])->name('customer.update-pro-status');
    Route::post('customer/update-vip-status', [CustomerController::class, 'updateVipStatus'])->name('customer.update-vip-status');
    Route::post('customer/update-adult-status', [CustomerController::class, 'updateAdultStatus'])->name('customer.update-adult-status');
	
	Route::group(['prefix' => 'shipping-setup', 'as' => 'shipping-setup.'], function () {
        Route::get('/', [ShippingSetupController::class, 'index'])->name('index');
        Route::post('store', [ShippingSetupController::class, 'store'])->name('store');
    });
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
	 Route::get('/admin/memberships', [AdminMembershipController::class, 'index'])->name('admin.memberships.index'); // List of pending memberships for admin approval
        Route::post('/admin/memberships/approve/{id}', [AdminMembershipController::class, 'approve'])->name('admin.memberships.approve'); // Approve membership
        Route::post('/admin/memberships/deny/{id}', [AdminMembershipController::class, 'deny'])->name('admin.memberships.deny'); // Deny membership (with reason)
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'ai-settings'], function () {
        ...
        Route::post('', [AISettingsController::class, 'update'])->name('ai-settings.update');
        
        // AI Images Gallery
        Route::get('images', [AIImagesController::class, 'index'])->name('ai-settings.images');
        Route::delete('images/{id}', [AIImagesController::class, 'destroy'])->name('ai-settings.images.destroy');
        Route::post('images/bulk-delete', [AIImagesController::class, 'bulkDelete'])->name('ai-settings.images.bulk-delete');
        Route::post('images/clear-old', [AIImagesController::class, 'clearOld'])->name('ai-settings.images.clear-old');
    });
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        ...
        // AI endpoints for product assist (Gemini 2.5 Flash Image)
        Route::controller(ProductAIController::class)->prefix('ai')->as('ai.')->group(function () {
            Route::post('analyze', 'analyze')->name('analyze');
            Route::post('generate-images', 'generateImages')->name('generate-images');
            Route::get('test-file-creation', 'testFileCreation')->name('test-file-creation');
        });
    });
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['middleware' => ['module:business_settings']], function () {
            ...
            Route::controller(ReferralSettingController::class)->group(function () {
                ...
                Route::put('referral-setting', 'update')->name('referral-setting.update');
            });
